...
window.title("YoungBlood (Login)") #window title
...
#background image
photo2=PhotoImage(file='loginpagebg.png')
...
#login frame
    Frame(window, height=440, width=350, bg='#8F00FF').place(x=610, y=170) #frame for login box
    Frame(window, height=80, width=330, bg='#8F00FF').place(x=610, y=170) #login frame title box
    Label(window, text='LOG IN', bg="#8F00FF", fg='white', font=('Arial',20,'bold')).place(x=725, y=200)
    ...
    mail_ent.place(x=630, y=300,width=260, height=30)
    ...
    ps_ent.place(x=630, y=350,width=260, height=30)
    ...
    Checkbutton(text='Show', offvalue=0, variable=showw, bg='#8F00FF', command=show).place(x=900, y=350)

    #login button
    # Button(window,text="LOGIN",font=('Arial',10,'bold'),fg='white',bg="#338bd7",width=16,height=2,cursor='hand2',command=login).place(x=200, y=420)

    #forgot password and signup links
    Button(window,text="Forgot Password?", fg='#8F00FF', bg='white', cursor='hand2',command=reset).place(x=850, y=400)
    Label(window, text="New Employee?", bg='#8F00FF',fg='white').place(x=730, y=500)
    Button(window, text="SIGN UP NOW", fg='white', bg='#8F00FF', cursor='hand2',command=opensignup).place(x=730, y=550)
    ...
    #login button
    Button(window,text="LOG IN",font=('Arial',10,'bold'),fg='white',bg="red",width=35,height=2,cursor='hand2',command=verify).place(x=650, y=450,width=260,height=40)
...
def reset():
    ...
    Frame(top,bg='#8F00FF',height=400,width=400).place(x=0,y=0)
    Label(top, text='RESET PASSWORD', bg="#8F00FF", fg='white', font=('Arial',20,'bold')).place(x=50, y=20)
    ...
    mail_ent.place(x=40,y=180,width=270)
    ...
    new_ps_ent.place(x=40, y=215,width=210, height=30)
    new_ps_ent.bind('<FocusIn>', remove2) #bind function is used to know the mouse movement (if it is clicked or hovering and so on)
    showw=IntVar(value=1)
    Checkbutton(top,text='Show',offvalue=0,variable=showw,bg='#8F00FF',command=show).place(x=260,y=215)
    ...
    new_psc_ent.place(x=40, y=250,width=210, height=30)
    ...
    Checkbutton(top,text='Show',offvalue=0,variable=showww,bg='#8F00FF',command=show2).place(x=260,y=250)

    Button(top,text="CONFIRM",font=('Arial',10,'bold'),fg='white',bg="red",width=16,height=2,cursor='hand2',command=lambda:verify()).place(x=120, y=300)
